<ul class="menu">
    <% loop $Menu(1) %>
        ...
        <% end_if %>
    <% end_loop %>
    <% if $SiteConfig.FormattedPhone %><li class="menu__item menu__item--icon"><a href="tel:{$SiteConfig.FormattedPhone}" class="menu__item__icon menu__item__icon--phone"><i class="menu__item__icon__icon fa fa-phone"></i><span class="menu__item__icon__text">Phone</span></a></li><% end_if %>
